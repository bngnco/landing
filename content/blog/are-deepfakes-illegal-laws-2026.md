...
- **The TAKE IT DOWN Act (federal, 2025)** criminalises publishing non-consensual intimate images — explicitly including AI-generated ones — and requires platforms to remove reported NCII within **48 hours**. This is the law that gives deepfake victims their fastest lever; the practical playbook is in [what to do if someone makes a deepfake of you](/blog/what-to-do-if-someone-makes-a-deepfake-of-you).
...
The **EU AI Act** takes the labelling route: its transparency obligations — fully applicable from **August 2026** — require that deepfakes be **clearly disclosed as artificially generated or manipulated**, and that AI systems mark their output in machine-readable form (in practice: C2PA-style provenance and watermarking — we explain that plumbing in [Content Credentials (C2PA) explained](/blog/content-credentials-c2pa-explained)).
...
**If you're a victim:** the law is more on your side than most victims assume — especially for intimate imagery, where takedown duties are now statutory in the US, UK and EU. Preserve evidence first, then use the priority lanes; the step-by-step is [here](/blog/what-to-do-if-someone-makes-a-deepfake-of-you).
...
**Can I go to jail for sharing a deepfake I didn't make?**
Yes, for some categories. Sharing non-consensual intimate deepfakes is a crime regardless of who made them, and knowingly spreading fraudulent media can attract liability. "I just forwarded it" is not the defence people assume — which is a good practical reason to [verify before you share](/blog/how-to-tell-if-an-image-is-ai-generated).

**Do AI companies have to label deepfakes?**
